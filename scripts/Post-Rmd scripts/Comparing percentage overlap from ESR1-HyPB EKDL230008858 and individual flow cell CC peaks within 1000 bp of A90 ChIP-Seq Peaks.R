...
ESR1_EK_HyPB_A90 = read.table("1kbp_A_ER_HyPB_EKDL230008858_fdr_bh_0.05_peaks_nor.bed_B_GSM2970404_A90_peaks.bed", header = TRUE, sep = "\t", col.names = col_names)
...
ESR1_HF5_HyPB_A90 = read.table("1kbp_A_ER_HyPB_HF552DSX7_L2_1_fdr_bh_0.05_peaks_nor.bed_B_GSM2970404_A90_peaks.bed", header = TRUE, sep = "\t", col.names = col_names)
...
ESR1_HF3_HyPB_A90 = read.table("1kbp_A_ER_HyPB_HFK3FDSX7_L2_1_fdr_bh_0.05_peaks_nor.bed_B_GSM2970404_A90_peaks.bed", header = TRUE, sep = "\t", col.names = col_names)
