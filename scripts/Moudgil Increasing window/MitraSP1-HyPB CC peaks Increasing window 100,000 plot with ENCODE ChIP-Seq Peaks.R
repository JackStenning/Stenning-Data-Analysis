...
#SP1
SP1_HyPB_ChIP_ENCODE_1000bp = read.table("A_MitraPeak_GSM4471639_HCT-116_SP1-HyPBase_peaks.tsv.bed_B_ENCODE/1000bp_A_MitraPeak_GSM4471639_HCT-116_SP1-HyPBase_peaks.tsv.bed_B_ENCODE", header = TRUE, sep = "\t", col.names = col_names)

SP1_HyPB_ChIP_ENCODE_5000bp = read.table("A_MitraPeak_GSM4471639_HCT-116_SP1-HyPBase_peaks.tsv.bed_B_ENCODE/5000bp_A_MitraPeak_GSM4471639_HCT-116_SP1-HyPBase_peaks.tsv.bed_B_ENCODE", header = TRUE, sep = "\t", col.names = col_names)

SP1_HyPB_ChIP_ENCODE_10000bp = read.table("A_MitraPeak_GSM4471639_HCT-116_SP1-HyPBase_peaks.tsv.bed_B_ENCODE/10000bp_A_MitraPeak_GSM4471639_HCT-116_SP1-HyPBase_peaks.tsv.bed_B_ENCODE", header = TRUE, sep = "\t", col.names = col_names)

SP1_HyPB_ChIP_ENCODE_20000bp = read.table("A_MitraPeak_GSM4471639_HCT-116_SP1-HyPBase_peaks.tsv.bed_B_ENCODE/20000bp_A_MitraPeak_GSM4471639_HCT-116_SP1-HyPBase_peaks.tsv.bed_B_ENCODE", header = TRUE, sep = "\t", col.names = col_names)

SP1_HyPB_ChIP_ENCODE_30000bp = read.table("A_MitraPeak_GSM4471639_HCT-116_SP1-HyPBase_peaks.tsv.bed_B_ENCODE/30000bp_A_MitraPeak_GSM4471639_HCT-116_SP1-HyPBase_peaks.tsv.bed_B_ENCODE", header = TRUE, sep = "\t", col.names = col_names)

SP1_HyPB_ChIP_ENCODE_40000bp = read.table("A_MitraPeak_GSM4471639_HCT-116_SP1-HyPBase_peaks.tsv.bed_B_ENCODE/40000bp_A_MitraPeak_GSM4471639_HCT-116_SP1-HyPBase_peaks.tsv.bed_B_ENCODE", header = TRUE, sep = "\t", col.names = col_names)

SP1_HyPB_ChIP_ENCODE_50000bp = read.table("A_MitraPeak_GSM4471639_HCT-116_SP1-HyPBase_peaks.tsv.bed_B_ENCODE/50000bp_A_MitraPeak_GSM4471639_HCT-116_SP1-HyPBase_peaks.tsv.bed_B_ENCODE", header = TRUE, sep = "\t", col.names = col_names)

SP1_HyPB_ChIP_ENCODE_60000bp = read.table("A_MitraPeak_GSM4471639_HCT-116_SP1-HyPBase_peaks.tsv.bed_B_ENCODE/60000bp_A_MitraPeak_GSM4471639_HCT-116_SP1-HyPBase_peaks.tsv.bed_B_ENCODE", header = TRUE, sep = "\t", col.names = col_names)

SP1_HyPB_ChIP_ENCODE_70000bp = read.table("A_MitraPeak_GSM4471639_HCT-116_SP1-HyPBase_peaks.tsv.bed_B_ENCODE/70000bp_A_MitraPeak_GSM4471639_HCT-116_SP1-HyPBase_peaks.tsv.bed_B_ENCODE", header = TRUE, sep = "\t", col.names = col_names)

SP1_HyPB_ChIP_ENCODE_80000bp = read.table("A_MitraPeak_GSM4471639_HCT-116_SP1-HyPBase_peaks.tsv.bed_B_ENCODE/80000bp_A_MitraPeak_GSM4471639_HCT-116_SP1-HyPBase_peaks.tsv.bed_B_ENCODE", header = TRUE, sep = "\t", col.names = col_names)

SP1_HyPB_ChIP_ENCODE_90000bp = read.table("A_MitraPeak_GSM4471639_HCT-116_SP1-HyPBase_peaks.tsv.bed_B_ENCODE/90000bp_A_MitraPeak_GSM4471639_HCT-116_SP1-HyPBase_peaks.tsv.bed_B_ENCODE", header = TRUE, sep = "\t", col.names = col_names)

SP1_HyPB_ChIP_ENCODE_100000bp = read.table("A_MitraPeak_GSM4471639_HCT-116_SP1-HyPBase_peaks.tsv.bed_B_ENCODE/100000bp_A_MitraPeak_GSM4471639_HCT-116_SP1-HyPBase_peaks.tsv.bed_B_ENCODE", header = TRUE, sep = "\t", col.names = col_names)

##Undirected HyPB
HyPB_ChIP_ENCODE_1000bp = read.table("A_MitraPeak_GSM4471638_HCT-116_HyPBase_peaks.tsv.bed_B_ENCODE/1000bp_A_MitraPeak_GSM4471638_HCT-116_HyPBase_peaks.tsv.bed_B_ENCODE", header = TRUE, sep = "\t", col.names = col_names)

HyPB_ChIP_ENCODE_5000bp = read.table("A_MitraPeak_GSM4471638_HCT-116_HyPBase_peaks.tsv.bed_B_ENCODE/5000bp_A_MitraPeak_GSM4471638_HCT-116_HyPBase_peaks.tsv.bed_B_ENCODE", header = TRUE, sep = "\t", col.names = col_names)

HyPB_ChIP_ENCODE_10000bp = read.table("A_MitraPeak_GSM4471638_HCT-116_HyPBase_peaks.tsv.bed_B_ENCODE/10000bp_A_MitraPeak_GSM4471638_HCT-116_HyPBase_peaks.tsv.bed_B_ENCODE", header = TRUE, sep = "\t", col.names = col_names)

HyPB_ChIP_ENCODE_20000bp = read.table("A_MitraPeak_GSM4471638_HCT-116_HyPBase_peaks.tsv.bed_B_ENCODE/20000bp_A_MitraPeak_GSM4471638_HCT-116_HyPBase_peaks.tsv.bed_B_ENCODE", header = TRUE, sep = "\t", col.names = col_names)

HyPB_ChIP_ENCODE_30000bp = read.table("A_MitraPeak_GSM4471638_HCT-116_HyPBase_peaks.tsv.bed_B_ENCODE/30000bp_A_MitraPeak_GSM4471638_HCT-116_HyPBase_peaks.tsv.bed_B_ENCODE", header = TRUE, sep = "\t", col.names = col_names)

HyPB_ChIP_ENCODE_40000bp = read.table("A_MitraPeak_GSM4471638_HCT-116_HyPBase_peaks.tsv.bed_B_ENCODE/40000bp_A_MitraPeak_GSM4471638_HCT-116_HyPBase_peaks.tsv.bed_B_ENCODE", header = TRUE, sep = "\t", col.names = col_names)

HyPB_ChIP_ENCODE_50000bp = read.table("A_MitraPeak_GSM4471638_HCT-116_HyPBase_peaks.tsv.bed_B_ENCODE/50000bp_A_MitraPeak_GSM4471638_HCT-116_HyPBase_peaks.tsv.bed_B_ENCODE", header = TRUE, sep = "\t", col.names = col_names)

HyPB_ChIP_ENCODE_60000bp = read.table("A_MitraPeak_GSM4471638_HCT-116_HyPBase_peaks.tsv.bed_B_ENCODE/60000bp_A_MitraPeak_GSM4471638_HCT-116_HyPBase_peaks.tsv.bed_B_ENCODE", header = TRUE, sep = "\t", col.names = col_names)

HyPB_ChIP_ENCODE_70000bp = read.table("A_MitraPeak_GSM4471638_HCT-116_HyPBase_peaks.tsv.bed_B_ENCODE/70000bp_A_MitraPeak_GSM4471638_HCT-116_HyPBase_peaks.tsv.bed_B_ENCODE", header = TRUE, sep = "\t", col.names = col_names)

HyPB_ChIP_ENCODE_80000bp = read.table("A_MitraPeak_GSM4471638_HCT-116_HyPBase_peaks.tsv.bed_B_ENCODE/80000bp_A_MitraPeak_GSM4471638_HCT-116_HyPBase_peaks.tsv.bed_B_ENCODE", header = TRUE, sep = "\t", col.names = col_names)

HyPB_ChIP_ENCODE_90000bp = read.table("A_MitraPeak_GSM4471638_HCT-116_HyPBase_peaks.tsv.bed_B_ENCODE/90000bp_A_MitraPeak_GSM4471638_HCT-116_HyPBase_peaks.tsv.bed_B_ENCODE", header = TRUE, sep = "\t", col.names = col_names)

HyPB_ChIP_ENCODE_100000bp = read.table("A_MitraPeak_GSM4471638_HCT-116_HyPBase_peaks.tsv.bed_B_ENCODE/100000bp_A_MitraPeak_GSM4471638_HCT-116_HyPBase_peaks.tsv.bed_B_ENCODE", header = TRUE, sep = "\t", col.names = col_names)
...
graphorder= c('S1', 
              ...
              'H90',
              'H100')
MitraSP1_HyPB_ENCODE_Incrw_Finalpercentage_table = data.frame(Name=graphorder,
...
#Plot
MitraSP1_HyPB_ENCODE_Incrw_Figure <- ggplot(data = MitraSP1_HyPB_ENCODE_Incrw_Finalpercentage_table, 
...
MitraSP1_HyPB_ENCODE_Incrw_Figure
########################################################################
