...
ESR1_HyPB_D90 = read.table("20231017outputs/1kbp_A_ER_HyPB_HFK3FDSX7_L2_1_fdr_bh_0.05_no-r_peaks.bed_B_GSM2970413_D90_peaks.bed", header = TRUE, sep = "\t", col.names = col_names)
Undir_HyPB_D90 = read.table("20231017outputs/1kbp_A_WT_HyPB_HFK3FDSX7_L2_1_p30_peaks.bed_B_GSM2970413_D90_peaks.bed", header = TRUE, sep = "\t", col.names = col_names)
